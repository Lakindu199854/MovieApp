...
public class MovieController {
    ...
    @GetMapping("/{id}")
    public ResponseEntity<Optional<Movie>> getMethodName(@PathVariable ObjectId id) {
        return new ResponseEntity<Optional<Movie>>(movieService.getMoviById(id),HttpStatus.OK);
    }
